...
if(True):
    ...
    files = sorted(glob.glob('steadystateW56muS3.pickle'))
    ...
    data.save(f'steadystate_muS{int(data.param.muS*100):02d}_w{int(data.W0/10):02}.pickle')

files = sorted(glob.glob(f'steadystate_muS{int(data.param.muS*100):02d}_w{int(data.W0/10):02d}.pickle'))
