...
plt.scatter(lengthTime[ind2:ind3]/1e3,UfTime[ind2:ind3]/365.25,[2],alpha=.25,color='xkcd:gray')
g = np.ones([np.shape(lengthTime[ind2:ind3])[0],2])
g[:,1] = np.log(lengthTime[ind2:ind3])
m3 = np.linalg.pinv(g) @ (np.log(UfTime[ind2:ind3]/365.25))
plt.plot(l/1e3,np.exp(m3[0])*l**m3[1],color='xkcd:cyan',linestyle='--',label=f'Power \n  ({np.exp(m3[0]):.3g})L^({m3[1]:.3g})')

g = np.ones([np.shape(lengthTime[ind2:ind3])[0],2])
g[:,1] = lengthTime[ind2:ind3]
m4 = np.linalg.pinv(g) @ (UfTime[ind2:ind3]/365.25)
plt.plot(l/1e3,m4[0] + l*m4[1],color='xkcd:green',linestyle='--',label=f'Linear \n  ({(m4[0]):.3g})+({m4[1]:.3g})L')

g = np.ones([np.shape(lengthTime[ind2:ind3])[0],2])
g[:,1] = np.log(lengthTime[ind2:ind3]+10e3)
m5 = np.linalg.pinv(g) @ (np.log(UfTime[ind2:ind3]/365.25))
plt.plot(l/1e3,np.exp(m5[0])*(l+10e3)**m5[1],color='xkcd:red',linestyle='--',label=f'Power shift \n  {m5}')
...
plt.ylim([0,350])
plt.legend()
plt.savefig("FittingPoly.png", format='png', dpi=400)
plt.show()
...
plt.plot(l/1e3,np.exp(m1[0])*l**(m1[1]),color='xkcd:red',linestyle='--',label='Linear Melt')
plt.plot(l/1e3,np.exp(m2[0])*l**(m2[1]),color='xkcd:blue',linestyle='--',label='U Melt')
plt.plot(l/1e3,np.exp(m3[0])*l**(m3[1]),color='xkcd:cyan',linestyle='--',label='Flat Melt')
plt.plot(l/1e3,np.exp(m4[0])*l**(m4[1]),color='xkcd:indigo',linestyle='--',label='Less Linear Melt')
plt.plot(l/1e3,np.exp(m5[0])*l**(m5[1]),color='xkcd:apple green',linestyle='--',label='Back Linear Melt')
...
plt.plot(l/1e3,np.exp(m1[0])*l**(m1[1])*365.25*Hf,color='xkcd:red',linestyle='--',label='Linear Melt')
plt.plot(l/1e3,np.exp(m2[0])*l**(m2[1])*365.25*Hf,color='xkcd:blue',linestyle='--',label='U Melt')
plt.plot(l/1e3,np.exp(m3[0])*l**(m3[1])*365.25*Hf,color='xkcd:cyan',linestyle='--',label='Flat Melt')
plt.plot(l/1e3,np.exp(m4[0])*l**(m4[1])*365.25*Hf,color='xkcd:indigo',linestyle='--',label='Less Linear Melt')
plt.plot(l/1e3,np.exp(m5[0])*l**(m5[1])*365.25*Hf,color='xkcd:apple green',linestyle='--',label='Back Linear Melt')
...
def eq(b,length,m):
	return np.exp(m[0])*length**(m[1])*365.25*(25) + b*365.25*length - 6000*600
...
plt.plot([np.min(l),np.max(l)],[.9, .9],color='xkcd:cyan',linestyle=':')
